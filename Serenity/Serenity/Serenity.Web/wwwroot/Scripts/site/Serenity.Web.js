...
(function (Serenity) {
    ...
    })(Organization = Serenity.Organization || (Serenity.Organization = {}));
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
    var Organization;
...
(function (Serenity) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return Serenity.LanguageList.getValue();
            };
    ...
    })(Northwind = Serenity.Northwind || (Serenity.Northwind = {}));
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
    var Northwind;
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Serenity.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Serenity.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Serenity) {
    ...
    (function (Northwind) {
        ...
        }(Serenity.Common.GridEditorDialog));
...
(function (Serenity) {
    ...
    (function (Northwind) {
        ...
        }(Serenity.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(Serenity.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Serenity.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Serenity.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Serenity.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (Serenity) {
    ...
    })(Meeting = Serenity.Meeting || (Serenity.Meeting = {}));
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
    var Meeting;
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: Serenity.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = Serenity.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
...
(function (Serenity) {
    ...
    Serenity.BasicProgressDialog = BasicProgressDialog;
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
    var Common;
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Serenity.BasicProgressDialog();
...
(function (Serenity) {
    ...
    })(DialogUtils = Serenity.DialogUtils || (Serenity.DialogUtils = {}));
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
    var Common;
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        }(Serenity.Northwind.OrderGrid));
        WrappedHeadersGrid = __decorate([
            Serenity.Decorators.registerClass()
        ], WrappedHeadersGrid);
        BasicSamples.WrappedHeadersGrid = WrappedHeadersGrid;
    })(BasicSamples = Serenity.BasicSamples || (Serenity.BasicSamples = {}));
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
    var BasicSamples;
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Serenity.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Serenity.Northwind.SalesByCategoryService.baseUrl; };
            /**
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                _this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: Serenity.Northwind.OrderRow.Fields.CustomerCompanyName,
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Serenity.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        }(Serenity.Northwind.SupplierGrid));
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Serenity.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Serenity.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Serenity.Northwind.OrderService.baseUrl; };
            /**
            ...
            QuickFilterCustomization.prototype.getQuickFilters = function () {
                ...
                var fld = Serenity.Northwind.OrderRow.Fields;
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        }(Serenity.Northwind.ProductGrid));
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Serenity.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Serenity.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Serenity.Northwind.ProductService.baseUrl; };
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Serenity.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
                        ...
                        var dlg = new Serenity.Northwind.OrderDialog();
                        this.initDialog(dlg);
                        dlg.loadEntityAndOpenDialog({
        ...
        }(Serenity.Northwind.CustomerGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = Serenity.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
...
(function (Serenity) {
    ...
    Serenity.SelectableEntityGrid = SelectableEntityGrid;
})(Serenity || (Serenity = {}));
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Serenity.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Serenity.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Serenity.Northwind.SupplierService.baseUrl; };
            return RowSelectionGrid;
        }(Serenity.SelectableEntityGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Serenity.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Serenity.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Serenity.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Serenity.Northwind.OrderDialog().loadEntityAndOpenDialog({
                        CustomerID: item.CustomerID,
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, Serenity.Northwind.OrderRow.Fields.ShipCountry);
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Serenity.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Serenity.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Serenity.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Serenity.Northwind.ProductRow.Fields;
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        }(Serenity.Common.BulkServiceAction));
...
(function (Serenity) {
    ...
    Serenity.StaticTextBlock = StaticTextBlock;
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
    var BasicSamples;
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        }(Serenity.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Serenity.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Serenity.Northwind.OrderDetailForm(_this.idPrefix);
                ...
                _this.form.ProductID.cascadeField = Serenity.Northwind.ProductRow.Fields.CategoryID;
                return _this;
        ...
        }(Serenity.Northwind.OrderDetailDialog));
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        }(Serenity.Northwind.OrderDetailsEditor));
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Serenity.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Serenity.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Serenity.Northwind.OrderService.baseUrl; };
        ...
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Serenity.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Serenity.Northwind.ProductRow.lookupKey;
            };
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Serenity.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Serenity.Northwind.CustomerDialog));
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Serenity.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Serenity.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Serenity.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Serenity.Northwind.OrderService.baseUrl; };
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        }(Serenity.Northwind.SupplierDialog));
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Serenity.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Serenity.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Serenity.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Serenity.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Serenity.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Serenity.Northwind.OrderService.baseUrl; };
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        var OtherFormOneBarDialog = (function (_super) {
            ...
            function OtherFormOneBarDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(Serenity.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Serenity.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
            ...
            OtherFormOneBarDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Serenity.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
            ...
            OtherFormOneBarDialog.prototype.saveCustomer = function (callback, onSuccess) {
                ...
                if (!id) {
                    ...
                    Serenity.Northwind.CustomerService.Update({
                        EntityId: id,
                        Entity: c
                    }, function (response) {
                        // reload customer list just in case
                        Q.reloadLookup(Serenity.Northwind.CustomerRow.lookupKey);
        ...
        }(Serenity.Northwind.OrderDialog));
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Serenity.Northwind.CategoryService.Retrieve({
        ...
        }(Serenity.Northwind.CategoryDialog));
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        }(Serenity.Northwind.CategoryGrid));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Serenity.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Serenity.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var chai = Serenity.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Serenity.Northwind.EmployeeRow.getLookup().items
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Serenity.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Serenity.BasicSamples || (Serenity.BasicSamples = {}));
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return Serenity.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return Serenity.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Serenity.BasicSamples || (Serenity.BasicSamples = {}));
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
...
(function (Serenity) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return Serenity.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return Serenity.StaticTextBlock; }], ['FromLocalText', function () { return Serenity.StaticTextBlock; }], ['DisplayFieldValue', function () { return Serenity.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Serenity.BasicSamples || (Serenity.BasicSamples = {}));
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
...
(function (Serenity) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'Serenity.Northwind.Entities.Gender');
    })(Northwind = Serenity.Northwind || (Serenity.Northwind = {}));
})(Serenity || (Serenity = {}));
var Serenity;
(function (Serenity) {
...
//# sourceMappingURL=Serenity.Web.js.map